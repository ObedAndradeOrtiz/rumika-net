    ...
    public static function plans(): array
    {
        return [
            ...
            [
                ...
                'sort_order' => 3,
                'features' => [
                    'modules' => ['inicio', 'agenda', 'clientes', 'historia_clinica', 'servicios', 'caja', 'facturacion', 'deudas', 'reportes', 'comisiones', 'sucursales', 'usuarios', 'roles', 'inventario', 'inventario_operaciones', 'gastos', 'estadisticas', 'crm', 'recursos_humanos'],
                    'limits' => [
                        'branches' => 3,
                        'users' => 10,
                        'clients' => 5000,
