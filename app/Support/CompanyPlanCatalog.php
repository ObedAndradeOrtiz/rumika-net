    ...
    public static function plans(): array
    {
        return [
            ...
            [
                ...
                'sort_order' => 2,
                'features' => [
                    'modules' => ['inicio', 'agenda', 'clientes', 'historia_clinica', 'servicios', 'caja', 'facturacion', 'sucursales'],
                    'limits' => [
                        'branches' => 1,
                        'users' => 3,
                        'clients' => 1000,
            ...
            [
                ...
                'sort_order' => 3,
                'features' => [
                    'modules' => ['inicio', 'agenda', 'clientes', 'historia_clinica', 'servicios', 'caja', 'facturacion', 'sucursales', 'usuarios', 'roles', 'inventario', 'inventario_operaciones', 'gastos', 'estadisticas'],
                    'limits' => [
                        'branches' => 3,
                        'users' => 10,
                        'clients' => 5000,
